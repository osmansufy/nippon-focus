...
function nippon_focus_scripts()
{
    ...
    wp_enqueue_style('css-style', get_theme_file_uri('assets/css/style.css'));
    ...
    wp_register_script('jquery-core','https://code.jquery.com/jquery-2.1.4.min.js', false, '2.1.4');
